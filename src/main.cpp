...
uint256 hashGenesisBlock("0x2f64fb8ea67008ff7f3db8a2cc5fa1767086808f775a36a74b02e44d46b1f91f");
...
const string strMessageMagic = "canabit Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // canabit: 1 days
static const int64 nTargetSpacing = 90; // canabit: 90 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal canabit miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "canabit", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2f64fb8ea67008ff7f3db8a2cc5fa1767086808f775a36a74b02e44d46b1f91f");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Created Saturday FEBRUARY 1 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x2f64fb8ea67008ff7f3db8a2cc5fa1767086808f775a36a74b02e44d46b1f91f"));
